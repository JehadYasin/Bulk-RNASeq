...
# By: Jehad Yasin, JoScience Institute
...
rqc(path = "C://Users//Jehad Yasin//OneDrive//Desktop//Cancer Genomics//RNASeq", pattern = ".fastq.gz")
...
# BAM files -> Count files by aid of exon-GTF indexing
...
colnames(fc) <- c("Sample 1", "Sample 2")


#Working on actual data----
f <- read.csv("C:\\Users\\Jehad Yasin\\OneDrive\\Desktop\\Cancer Genomics\\RNASeq\\GSE143630_RCC_htseq_counts.txt",
              sep=" ", 
              row.names = 1)
